 ...
 * 企业管家购买服务
 */
public class MyCreditFragment extends BaseFragment  implements RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public static MyCreditFragment getInstance(){
        MyCreditFragment myOrderFragment=new MyCreditFragment();
