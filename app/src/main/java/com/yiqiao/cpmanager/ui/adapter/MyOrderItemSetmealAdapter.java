 ...
 */
public class MyOrderItemSetmealAdapter extends RecyclerArrayAdapter<OrderVo.OrderListBean> {

    public MyOrderItemSetmealAdapter(Context context, List<OrderVo.OrderListBean> arrayList) {
