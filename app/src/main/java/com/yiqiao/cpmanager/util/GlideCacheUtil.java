...
public class GlideCacheUtil {
    ...
    public static String getCacheSize() {
        try {
//            return getFormatSize(getFolderSize(new File(App.getInstance().getCacheDir() + "/" + InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
            return Formatter.formatFileSize(App.getInstance(),getFolderSize(new File(App.getInstance().getCacheDir() + "/" + InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public  boolean cleanCatchDisk() {
        return deleteFolderFile(App.getInstance().getCacheDir() + "/" + InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR, true);
    }
